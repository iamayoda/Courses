...
#1. INDEX ERROR - When you try to access an item that is not in the range of the List
print(states_of_america[49])  # No error
print(states_of_america[50])  # IndexError

#1.1 Using len() to find the number of items in a List
num_states = len(states_of_america)
print(states_of_america[num_states - 1])


#2. NESTED LISTS - Putting Lists inside other Lists
